            ...
            <div className="w-full border">
              <div className=" bg-gray-100">
                <div className="flex border-b-2 w-full items-center bg-white mb-5 py-3 pl-3">
                  <img
                    src="https://i.ibb.co/xChCQ7F/bg1.jpg"
                    alt=""
                ...
                <div className="flex items-center pl-3">
                  <span className="bg-green-600 text-white rounded-[50px] p-1 mr-3">
                    AM
                  </span>
                  <h2 className="text-lg font-bold">Abdul hoi Momin</h2>
                </div>
                <p className="pl-3">
                  Made you as admin on the board{" "}
                  <strong className="underline">Pro-man</strong> Jul 21 at 10.5
                  PM
                </p>
              </div>
            </div>
