...
const TempleteBoard = ({ openTemp, setOpenTemp }) => {
  ...
  const bTempletes = [
    {
      _id: 1,
      imgURL: "https://i.ibb.co/t2FDrsK/pexels-felix-mittermeier-956981.jpg",
      name: "Agile Board",
    },
    {
      _id: 2,
      imgURL: "https://i.ibb.co/ZKgZCdc/pexels-isaac-garcia-13173092.jpg",
      name: "Company Overview",
    },
    {
      _id: 3,
      imgURL: "https://i.ibb.co/DQ4pSjB/pexels-rafael-guajardo-604684.jpg",
      name: "Design Huddle ",
    },
    {
      _id: 4,
      imgURL:
        "https://i.ibb.co/sQmZfgC/keith-misner-h0-Vxgz5ty-XA-unsplash.jpg",
      name: "Kanban Template ",
    },
    {
      _id: 5,
      imgURL:
        "https://i.ibb.co/7JVRYtw/jeremy-bishop-G9i-plbf-Dgk-unsplash.jpg",
        ...
        {!openTempBM && (
          ...
          >
            <div>
              ...
              <h1 className="text-md text-center mb-3">Templetes</h1>
              <label
                ...
                bTempletes.map((templete) => (
                  ...
                  >
                    <img
                      ...
                      alt=""
                    />{" "}
                    <p className="ml-2">{templete.name}</p>
                  </div>
                ))}
            </div>
          </label>
