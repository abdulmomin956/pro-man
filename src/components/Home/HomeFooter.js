...
const HomeFooter = () => {
    return (
        <div>
            <footer className="footer grid grid-cols-1 md:grid-cols-3 p-10 bg-blue-900 text-base-content">
                ...
                <div className='text-white'>
                    ...
                    <a className="link link-hover" href='#Home'>Terms of use</a>
                    <a className="link link-hover" href='#Home'>Privacy policy</a>
                    <a className="link link-hover" href='#Home'>Cookie policy</a>
                </div>
            </footer>
            <footer className="footer px-10 py-4 border-t bg-blue-900 text-white border-base-300">
