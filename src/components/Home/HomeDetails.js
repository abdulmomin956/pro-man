            ...
            <div class="hero lg:px-20 my-6">
                <div class="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='lg:mr-20'>
                        ...
                        <p class="py-6 text-justify">Proman cards are your portal to more organized work—where every single part of your task can be managed, tracked, and shared with teammates. Open any card to uncover an ecosystem of checklists, due dates, attachments, conversations, and more.</p>
            ...
            <div class="hero lg:px-20">
                <div class="hero-content flex-col lg:flex-row ">
                    ...
                    <div className='lg:ml-20'>
                        ...
                        <p class="py-6 text-justify">Let the robots do the work—so your team can focus on work that matters. With Pro-man’s built-in automation, Butler, reduce the number of tedious tasks (and clicks) on your project board by harnessing the power of automation across your entire team.</p>
            ...
            <div class="hero lg:px-20 my-6">
                <div class="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='lg:mr-20'>
                        ...
                        <p class="py-6 text-justify">Easily connect the apps your team already uses into your Pro-man workflow, or add a Power-Up that helps fine-tune one specific need. With hundreds of Power-Ups available, your team’s workflow wishes are covered.</p>
