...
const WorkFieldDemo = () => {
    return (
        <div>
            <img className='w-1/2 mx-auto' src="https://cdn.pixabay.com/photo/2019/03/12/20/27/business-4051773_960_720.jpg" alt="" />

            <div className='mb-6 mt-8 mx-auto lg:text-center w-1/2 sm:text-justify'>
