...
const Banner = () => {
    return (
        <div className="hero h-screen  lg:px-20  ">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className='lg:mr-40 sm:mr-0 sm:mt-16 sm:px-20 lg:px-0  '>
                    ...
                    <h1 data-aos="fade-up" data-aos-duration="1500" data-aos-delay="200" className="text-4xl  font-bold text-primary">ProMan helps teams move work forward.</h1>
